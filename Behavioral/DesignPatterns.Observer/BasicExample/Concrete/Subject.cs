...
namespace DesignPatterns.Observer.BasicExample.Concrete
{
    ...
    public class Subject : ISubject         // (Publisher)
    {
        ...
        {
            Console.WriteLine("Subject: Attached/Subscribed an observer.");
        ...
        public void Detach(IObserver observer)
        {
            ...
            Console.WriteLine("Subject: Detached/Unsubscribed an observer.");
        }
